package com.aasim.electonic.store.ProjectElectronicStore.Controllers;
...
import com.aasim.electonic.store.ProjectElectronicStore.security.JwtHelper;
import com.aasim.electonic.store.ProjectElectronicStore.security.JwtRequest;
import com.aasim.electonic.store.ProjectElectronicStore.security.JwtResponse;
    ...
    private void doAuthenticate(String email, String password){
        UsernamePasswordAuthenticationToken authenticationToken =  new UsernamePasswordAuthenticationToken(email,password);
             try{
                 ...
                 //authenticaiton done . as username and password existing in the database .
